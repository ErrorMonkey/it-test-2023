...
|            테스트 영상            |             코드             |
| :-------------------------------: | :--------------------------: |
| <img src="./_temp/01-main.gif" /> | <img src="./_temp/seq1.png"> |

메인 화면에 들어오면 DB에서 응시자와 점수 데이터를 조회해 시퀄라이즈로 총 유저 수, 평균 점수, 만점자 수를 메인 화면에 보여주도록 했습니다.
...
|             테스트 영상              |                코드                |
| :----------------------------------: | :--------------------------------: |
| <img src="./_temp/02-test-keep.gif"> | <img  src="./_temp/test-page.png"> |

테스트를 시작하면 문제를 배열로 가져와 DOM API로 버튼과 문제 요소를 갱신합니다.

### 결과 화면

|                테스트 영상                |                코드                 |
| :---------------------------------------: | :---------------------------------: |
| <img src="./_temp/03-result-comment.gif"> | <img src="./_temp/result-page.png"> |
